import './style.css';
const PROFILE = {"day":"Day065","title":"Warranty Pocket Keeper","display_name_ja":"保証書ポケット","one_sentence":"買った物と保証期限を、あとで探せるポケットにするツール","purpose_line_ja":"保証書ポケットを作るためのツールです。","use_case_line_ja":"家電を買った後、保証書をどこへ置くか決めたい時に使います。","how_it_works_line_ja":"項目を入れると、結果カードが出ます。","core_action":"block_fill","family":"warranty_deadline_log","mechanic":"block_fill","input_style":"receipt_items","output_style":"return_box","output_label":"ここを見ればOKです","audience_promise":"あとで探す物と場所を買った日に固定できる。","publish_hook":"保管場所と期限と必要書類が一画面で見え、買った直後に置き先が決まる。","engine":"brief_driven","interaction_archetype":"block_fill","page_archetype":"parcel_box","ui_variant":"request","intro_variant":"request_frame","interaction_model":"fill_missing_request_blocks","primary_layout":"request_cards_grid","result_presentation_style":"missing_vs_filled_cards","palette_motif":"依頼メモサンド","main_cta":"依頼メモで試す","input_panel_title":"空いている枠を埋める","sample_panel_title":"依頼メモで試す","guide_panel_title":"抜けを減らすコツ","hero_panel_label":"伝わる依頼文","output_shape":"parcel_box","state_model":"block_fill_state","core_loop":"receipt_items -> block_fill -> return_box","component_pack":"parcel_box+return_box","scaffold_id":"brief_canvas","single_shot_text_generator":false};
